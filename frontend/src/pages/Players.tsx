...
//   // 1. Standings Data (Specific to the current group)
...
//   // 2. Global History Data
//   // We reverse each season individually, then combine them.
//   // This puts Winter (most recent to oldest) at the top, then Summer (most recent to oldest).
...
//                 {/* Column 1: Meta (Season/Date) */}
//                 <div className="hist-col-meta">
//                   <span className={`season-badge ${game.season.toLowerCase()}`}>
//                     {game.season}
//                   </span>
//                   <span className="game-date">{game.date || '---'}</span>
//                 </div>

//                 {/* Column 2: Main Matchup Information */}
...
//                 {/* Column 3: Stats Columns */}
//                 <div className="hist-col-stats">
//                   {pStats ? (
//                     <>
//                       <div className="hist-stat-val">
//                         <strong>{pStats.points}</strong>
//                         <small>PTS</small>
//                       </div>
//                       <div className="hist-stat-val">
//                         {pStats['2pt_m']}/{pStats['2pt_a']}
//                         <small>2P</small>
//                       </div>
//                       <div className="hist-stat-val">
//                         {pStats['3pt_m']}/{pStats['3pt_a']}
//                         <small>3P</small>
//                       </div>
//                     </>
//                   ) : (
...
//           {groupId === 'derrick' ? 'Winter 2026 Standings' : 'Summer 2025 Standings'}
//         </h2>
